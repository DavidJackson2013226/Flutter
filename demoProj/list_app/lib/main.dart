...
//
//   MyApp({Key key = const Key(""), @required this.products = const []}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
...
//   final Choice choice;
//   const SelectCard({Key key = const Key(""), this.choice = const Choice(title: "",icon: Icons.add)}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     final TextStyle textStyle = TextStyle(fontSize: 28, fontWeight: FontWeight.bold);
//     return Card(
